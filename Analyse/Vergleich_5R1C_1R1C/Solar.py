...
from Models.Other_Models.RadProc import RadProc
...
# plt.plot(df_5R1C.index[0:bis], [i/140 for i in phi_HC][0:bis], c = 'grey', label = 'phi_int/100')
...
plt.plot(df_5R1C.index[0:bis], [(a+b)/100 for a,b in zip(inp['B'],inp['D'])][0:bis], c = 'tab:orange', label = "Global Irradiation [W/m²/100]")
